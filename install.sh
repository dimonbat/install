...
#clean disk (need for correct zis info save on new clean disk)
echo "clean disk"
dd if=/dev/zero of=${partition} bs=1024 count=10

#make label (its need for clean disk)
echo "make label"
